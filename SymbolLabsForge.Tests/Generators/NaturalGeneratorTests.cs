//===============================================================
// File: NaturalGeneratorTests.cs
// Author: Claude (Phase III-G)
// Date: 2025-11-14
// Purpose: Snapshot tests for NaturalGenerator with tight tolerance.
...
{
    public class NaturalGeneratorTests
    {
        private readonly NaturalGenerator _generator = new();

        [Fact]
        public void GenerateRawImage_WithValidDimensions_ReturnsImageOfCorrectSize()
        {
            // Arrange
            var dimensions = new Size(20, 50);
        ...
        public void GenerateRawImage_IsNotEmptyAndContainsBlackPixels()
        {
            ...
            Assert.True(containsBlackPixel, "The generated Natural image should not be empty.");
        }
        ...
        public void GenerateRawImage_MatchesVerifiedSnapshot()
        {
            // Arrange
            var dimensions = new Size(20, 50);
            var snapshotPath = Path.Combine("TestAssets", "Snapshots", "Generators", "NaturalGenerator_ValidDimensions_Expected.png");
            var diffPath = Path.Combine("TestAssets", "Diffs", "Generators", "NaturalGenerator_ValidDimensions_Diff.png");
            ...
            // Natural symbol uses binary geometry with no AA - enforce near-zero tolerance
