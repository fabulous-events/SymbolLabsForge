//===============================================================
// File: SharpGeneratorTests.cs
// Author: Claude (Phase III-G)
// Date: 2025-11-14
// Purpose: Snapshot tests for SharpGenerator with tight tolerance.
...
{
    public class SharpGeneratorTests
    {
        private readonly SharpGenerator _generator = new();
        ...
        public void GenerateRawImage_IsNotEmptyAndContainsBlackPixels()
        {
            ...
            Assert.True(containsBlackPixel, "The generated Sharp image should not be empty.");
        }
        ...
        public void GenerateRawImage_MatchesVerifiedSnapshot()
        {
            // Arrange
            var dimensions = new Size(20, 50);
            var snapshotPath = Path.Combine("TestAssets", "Snapshots", "Generators", "SharpGenerator_ValidDimensions_Expected.png");
            var diffPath = Path.Combine("TestAssets", "Diffs", "Generators", "SharpGenerator_ValidDimensions_Diff.png");
            ...
            // Sharp symbol uses binary geometry with no AA - enforce near-zero tolerance
